...
<head>
    ...
    <!-- Swiper -->
    <link rel="stylesheet" href="<?=$GLOBALS['COD']->dir?>/assets/css/Swiper/swiper.min.css?<?=$elapsed_time?>">
    <!-- Your Styles -->
    ...
    <!-- Top Bar -->
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          <a class="navbar-brand" href="index.html"><img src='<?=$GLOBALS['COD']->dir?>/assets/images/Logo.png?<?$elapsed_time?>' alt="Logo Cristhian" class="IconoB"></a>
